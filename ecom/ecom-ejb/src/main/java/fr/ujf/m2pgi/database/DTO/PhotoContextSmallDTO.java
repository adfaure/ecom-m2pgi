...
public class PhotoContextSmallDTO {
	...
	public PhotoContextSmallDTO(long photoID, long sellerID,  String name, Date dateCreated, String privateLocation, String thumbnail, float price, Integer views, Integer likes,
